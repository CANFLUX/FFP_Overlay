...
# See original code here: https://footprint.kljun.net/
...
def FFP(index,umean,ustar,sigmav,h,ol,wind_dir,z0,zm,theta,rho,x_2d,basemap=None):
    ...
    if z0 is not None:
        ...
        if (np.log(zm / z0)-psi_f)>0:
            ...
            sys.exit(str(np.log(zm / z0)-psi_f),' > ', psi_f,'Cannot compute FP for these conditions')
