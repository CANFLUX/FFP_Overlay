...
<div style="overflow: hidden;
  padding-top: 75%;
  position: relative">
  <iframe src="Example_Outputs/FishIsland_FFP_2m.html" title="Processes" scrolling="no" frameborder="0"
    style="border: 0;
   height: 100%;
   left: 0;
   position: absolute;
...
Flux footprint climatology (2017 Growing Season) for Fish Island
